...
btnGet.addEventListener("click", () => {
  ...
  cartero.addEventListener("readystatechange", () => {
    // cartero.readyState, esta es una propiedad que me dice cual es la situacion, como cuando hacemos un seguimiento y nos dice, salio a destino, esta en x avion, y lo hara mediante numeros del 1 al 4

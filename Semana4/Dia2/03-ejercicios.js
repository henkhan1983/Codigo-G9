...
//   console.log(`El precio final sera: ${precioOriginal * 0.85}`)
// }else{
//   console.log(`El precio final sera: ${precioOriginal * 0.92}`)
// }
...
// let cantPlatos = +prompt("Cuantos asistentes/comensales tendrá el evento?");
